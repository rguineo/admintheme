...
$mail->Body = " <div style='width: 80%; margin-left: 10px; '>
                    ...
                    <div class='header' style='width: 60%;'>
                        <img class='logo' src='http://sgtaller.duotek.cl/views/dist/img/login.png' alt='' width='150' height='30' style='margin-left: 20px; margin-top: 20px;'><br><hr><br>         
                        <h3 class='titulo' style='text-align: center; color: #000;'>Notificación Informe Técnico Orden de trabajo Nº: ".$orden." Completado!</h3>
                    </div>
                    <div class='section' style='margin: 0;'>
                        <br>
                        <p style='color: black;'>Hoy ".date("d/m/Y G:i:s")." Se ha enviado notificación a las cuentas de administracion para realizar cotización correspondiente. </p>
                        <br>
                        <br>
                        <p> Este e-mail se ha generado automaticamente, favor no responder este correo</p>
                        <br>
